...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : NetworkBehaviour
    {
        ...
        [Command]
        void CmdMove(float rollInput, float pitchInput, float yawInput, float throttleInput, bool airBrakes)
        {
            RpcMove(rollInput, pitchInput, yawInput, throttleInput, airBrakes);
        }

        [ClientRpc]
        void RpcMove(float rollInput, float pitchInput, float yawInput, float throttleInput, bool airBrakes)
        {
            if (isLocalPlayer)
                return;
